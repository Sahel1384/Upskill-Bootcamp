      ...
      {UI === "UI, UX" ? (
        <>
          <div className="px-5 md:px-10 mt-28 flex flex-col justify-start items-start gap-8">
            ...
            <div className="grid justify-center items-center grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
              {Data.map((data) => (
                <div
                  key={data.id}
                  className="flex w-full flex-col gap-2 justify-center items-center sm:justify-start sm:items-start"
                >
            ...
            <div className="grid justify-center items-center grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
              {Readable.map((data) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 justify-start items-start">
                    <h1 className="text-[12px] lg:text-[11px] xl:text-[14.5px] font-semibold">
                      {data.title}
                    </h1>
                    <div className="flex justify-between items-center w-full">
                      <p className="text-[10px] sm:text-[11px]">
                      ...
                      <span className="text-[10px] bg-color8 px-2  py-[2px] rounded-xl font-semibold sm:text-[11px]">
                        {data.date}
                      </span>
                    </div>
                  </div>
